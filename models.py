...
def seed_data(session: Session) -> None:
    ...
    if session.query(Staff).count() == 0:
        ...
        drivers = [
            {"Name": "John", "Surname": "Doe", "Gender": "Male", "Age": 20, # Group 1
             "Bank_Account": "BA1001", "Liscence": 12345,
             "Postal_Code": postal_codes[0], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Jane", "Surname": "Smith", "Gender": "Female", "Age": 35, # Group 2
             "Bank_Account": "BA1002", "Liscence": 12346,
             "Postal_Code": postal_codes[0], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Alice", "Surname": "Brown", "Gender": "Female", "Age": 48, # Group 3
             "Bank_Account": "BA1003", "Liscence": 12347,
             "Postal_Code": postal_codes[0], "Busy_Until": datetime.now() - timedelta(minutes=5)},

            {"Name": "Bob", "Surname": "Johnson", "Gender": "Male", "Age": 22, # Group 2
             "Bank_Account": "BA1004", "Liscence": 12348,
             "Postal_Code": postal_codes[1], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Emily", "Surname": "Davis", "Gender": "Female", "Age": 18, # Group 1
             "Bank_Account": "BA1005", "Liscence": 12349,
             "Postal_Code": postal_codes[1], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Chris", "Surname": "Wilson", "Gender": "Male", "Age": 55, # Group 3
             "Bank_Account": "BA1006", "Liscence": 12350,
             "Postal_Code": postal_codes[1], "Busy_Until": datetime.now() - timedelta(minutes=5)},

            {"Name": "Sophia", "Surname": "Martinez", "Gender": "Female", "Age": 30, # Group 2
             "Bank_Account": "BA1007", "Liscence": 12351,
             "Postal_Code": postal_codes[2], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Liam", "Surname": "Anderson", "Gender": "Male", "Age": 19, # Group 1
             "Bank_Account": "BA1008", "Liscence": 12352,
             "Postal_Code": postal_codes[2], "Busy_Until": datetime.now() - timedelta(minutes=5)},
            {"Name": "Olivia", "Surname": "Taylor", "Gender": "Female", "Age": 42, # Group 3
             "Bank_Account": "BA1009", "Liscence": 12353,
             "Postal_Code": postal_codes[2], "Busy_Until": datetime.now() - timedelta(minutes=5)},
        ]
